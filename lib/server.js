...
var CACHE_ENTRIES_MAX, CACHE_GC_MINS, CACHE_MAX_AGE_HRS, CORSify, Locations, PROGRAM, VENDOR, WWWDIR, WeatherCache, alignRight, cleanCache, connect, express, getLocations, getWeatherByGeo, getWeatherByZip, handleError, http, log, logDate, logError, logRequest, lruCache, main, path, permanentRedirectWithSlash, weather;
...
alignRight = function(string, length, pad) {
